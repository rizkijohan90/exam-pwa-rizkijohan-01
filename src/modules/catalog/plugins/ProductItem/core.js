            ...
            <>
                ...
                <div
                    className={classNames(
                        ...
                        'flex flex-col swift-catalog-item-product group',
                        className,
                    )}
                >
                        ...
                        <Show when={showWishlist || showProductCompare}>
                            <div
                                className={classNames(
                                    ...
                                    'desktop:group-hover:visible',
                                    'absolute px-3 py-2',
                                    'left-1/2 bottom-4 -translate-x-1/2 z-[2]',
                                )}
                            >
                                <div className="flex-row gap-1 hidden tablet:flex desktop:flex">
                                    <Show when={showWishlist && !usedInWishlist}>
                                        <Button
                                            ...
                                            icon={<HeartIcon />}
                                            iconProps={{
                                                className: feed ? '!w-4 !h-4 text-neutral-600' : '!w-5 !h-5',
                                            }}
                                            variant={feed ? 'primary' : 'outlined'}
                                            onClick={() => handleFeed(props)}
                                            className={classNames(
                                                'swift-action-towishlist !p-0 w-9 h-9 !border-neutral-50',
                                                'bg-neutral-white/80 text-neutral-600 hover:!opacity-100',
                                    ...
                                    <Show when={usedInWishlist}>
                                        <Button
                                            iconOnly
                                            icon={<TrashIcon />}
                                            iconProps={{ className: '!w-5 !h-5 text-neutral-600' }}
                                            variant="outlined"
                                            onClick={() => handlingRemove()}
                                            className={classNames(
                                                'swift-action-toremove !p-0 w-9 h-9 !border-neutral-50',
                                                'bg-neutral-white/80 text-neutral-600 hover:!opacity-100',
                                                'flex items-center justify-center',
                                            )}
                                        />
                                    ...
                                    <Show when={showProductCompare}>
                                        <Button
                                            ...
                                            className={classNames(
                                                'swift-action-tocompare !p-0 w-9 h-9 !border-neutral-50',
                                                'bg-neutral-white/80 text-neutral-600 hover:!opacity-100',
                                                'flex items-center justify-center',
                                            )}
                                        />
